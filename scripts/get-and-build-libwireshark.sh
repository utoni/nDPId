...
WIRESHARK_ARCHIVE="wireshark-v4.4.16"
GITHUB_FALLBACK_URL="https://gitlab.com/wireshark/wireshark/-/archive/v4.4.16/${WIRESHARK_ARCHIVE}.zip"
...
pushd ./libWireshark
${CMAKE_EXEC} "${CMAKE_ARGS[@]}" -S . -B "${BUILD_DIR}"
